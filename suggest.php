...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message) && $_POST["address"] != "") { //we addedd a css style none to this attr in form below to catch SPAM Honeypot spams
    ...
    if(!isset($error_message)) {
        ...
        //Create a new PHPMailer instance from vendor\phpmailer
        $mail = new PHPMailer;
        ...
        $mail->setFrom('mojopoly1988@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('mojopoly1988@gmail.com', 'Cyrus Eslamian');
...
<div class = "section page">
    <div class= "wrapper">
        ...
        <?php 
        if (isset($_GET["status"]) && $_GET["status"] == "thanks") { //we defined the get[status] on line 18 with header
            ...
            <form method="post" action="suggest.php">
                <table>
                    ...
                    <tr>
                        <th><label for ="catrgory">Category (required)</label></th>
                        <td><select id ="category" name="category" >
                            <option value="">Select One</option>
                            <option value="Books" <?php if(isset($category) && $category= "Books"){echo " selected";} ?> >Book</option> <?php // the value field should be exactly what we have defined in the array?>
